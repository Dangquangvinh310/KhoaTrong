    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body demo-vertical-spacing demo-only-element">
                <form class="forms-sample" action="{{route('xl_them_nhan_vien_dau',['id' => $tuyenDung->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" placeholder="Nhập họ tên" id="ho_ten" name="ho_ten" value="{{$tuyenDung->ho_ten}}" required readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
