...
<div class="row">
    <div class="col-12">
        <div class="card">
        <h5 class="card-header">Cập nhật tin tức</h5>
            <div class="card-body demo-vertical-spacing demo-only-element">
                <form class="forms-sample" action="{{route('xl_cap_nhat_tin_tuc',['id' => $tinTuc->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
