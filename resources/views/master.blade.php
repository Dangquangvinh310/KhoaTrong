          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{route('danh_sach_hop_dong')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Hợp đồng</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Nhân sự</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('danh_sach_nhan_vien')}}" class="menu-link">
                    <div data-i18n="Without menu">QL Nhân viên</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('danh_sach_bhxh')}}" class="menu-link">
                ...
                <li class="menu-item">
                  <a href="{{route('danh_sach_phong_ban')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{route('danh_sach_tuyen_dung')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">{{auth()->user()->ho_ten}}</span>
                            <small class="text-muted">{{auth()->user()->chucVu->ten_chuc_vu}}</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="{{route('cap_nhat_thong_tin')}}">
